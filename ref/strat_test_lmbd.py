...
for lmbd in [5, 10, 15, 20, 25]:
    ...
    for i in range(len(date_list)-1):
        ...
        # 3、求解结果展示
        print('========lambda='+str(lmbd)+'--'+date+'优化结果'+'========')
    ...
    # port_ret.to_csv('/Users/zhangchi/富国实习/组合优化/Output/沪深300增强/lambda='+str(lmbd)+'指数内增强组合日度收益.csv', header=True)
